...
namespace MonoMac.Foundation {
	...
	public partial class NSUrlConnection {
		...
		public virtual void Schedule (NSRunLoop aRunLoop, string forMode)
		{
			...
			var nsforMode = new NSString (forMode);
			
			if (IsDirectBinding) {
				Messaging.void_objc_msgSend_IntPtr_IntPtr (this.Handle, selScheduleInRunLoopForMode_, aRunLoop.Handle, nsforMode.Handle);
			} else {
				Messaging.void_objc_msgSendSuper_IntPtr_IntPtr (this.SuperHandle, selScheduleInRunLoopForMode_, aRunLoop.Handle, nsforMode.Handle);
			}
			nsforMode.Dispose ();
		}
		...
		public virtual void Unschedule (NSRunLoop aRunLoop, string forMode)
		{
			...
			if (IsDirectBinding) {
				Messaging.void_objc_msgSend_IntPtr_IntPtr (this.Handle, selUnscheduleFromRunLoopForMode_, aRunLoop.Handle, nsforMode.Handle);
			} else {
				Messaging.void_objc_msgSendSuper_IntPtr_IntPtr (this.SuperHandle, selUnscheduleFromRunLoopForMode_, aRunLoop.Handle, nsforMode.Handle);
			}
			nsforMode.Dispose ();
		}
